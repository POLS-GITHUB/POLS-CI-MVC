        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="block">
                    ...
                    ?>
                        <form id="contact-form" method="post" action="<?php echo base_url('Admin/Store_article');?>" role="form">
                            ...
                            <div id="error" class="error">
                                ...
                                <?php 
                                    echo form_submit(['name'=>'submit','value'=>'Add','id' =>'contact-submit','class'=>'btn btn-default btn-send']);
                                ?>                            
                            </div>
                        </form>
                    </div>
